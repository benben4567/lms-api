...
class InstrukturController extends Controller
{
    public function index($page = 1)
    {
        ...
        $postfields = "apikey=&signature=".env('SIGNATURE')."&query=SELECT * FROM m_instruktur ".$limit;

        // dd($postfields);
        // $postfields = "apikey=&signature=".env('SIGNATURE')."&query=SELECT * FROM m_instruktur LIMIT 0,20";
    ...
    {
        $postfields = "apikey=&signature=".env('SIGNATURE')."&query=SELECT * FROM m_instruktur WHERE m_instruktur.id_instruktur = ".$id;
